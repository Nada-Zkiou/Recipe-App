...
const GET_USER_RECIPES = gql`
    query GetUserProfileRecipes($userId: ID!) {
        getUserProfileRecipes(userId: $userId) {
            id
            title
            ingredients
            steps
...
const UserProfile = () => {
    ...
    const recipes = data.getUserProfileRecipes;

    return (
        <div className="container mx-auto my-8">
            <h1 className="text-4xl font-bold mb-4">User's Recipes</h1>
            {recipes.length > 0 ? (
